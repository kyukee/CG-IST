...
function addArenaBase(obj, x, y, z) {
    'use strict'
    // width, height, depth
    geometry = new THREE.CubeGeometry(100, 1, 50);
    mesh = new THREE.Mesh(geometry, material);
    mesh.position.set(x, y, z);
    obj.add(mesh);
}
...
function addArenaShortWall(obj, x, y, z) {
    'use strict'
    // width, height, depth
    geometry = new THREE.CubeGeometry(1, 11.18, 50);
    mesh = new THREE.Mesh(geometry, material);
    mesh.position.set(x, y, z);
    obj.add(mesh);
}
...
function addArenaLongWall(obj, x, y, z) {
    'use strict'
    // width, height, depth
    geometry = new THREE.CubeGeometry(100, 11.18, 1);
    mesh = new THREE.Mesh(geometry, material);
    mesh.position.set(x, y, z);
...
function createArena(x, y, z) {
    ...
    addArenaShortWall(arena, 50.5, 6.09, 0);
    addArenaShortWall(arena, -50.5, 6.09, 0);
    addArenaLongWall(arena, 0, 6.09, 25.5);
    addArenaLongWall(arena, 0, 6.09, -25.5);
